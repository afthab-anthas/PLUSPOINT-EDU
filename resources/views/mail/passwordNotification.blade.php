...
<head>
    ...
    <title>User Password Reset Successful</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>Account Password Successfully Changed</h1>
        </div>
        <div class="content">
            <p>Hello {{ $mailData['name']}}</p>
            <p>
                Your request to reset your password for your Plus Point Education Portal account has been successful. <br> Welcome Back!
            </p>
